...
export const COLLECTIONS: { handle: string; label: string; description: string }[] = [
  {
    handle: "aprons-gowns-coats",
    label: "Aprons & Coats",
    description: "Coveralls, isolation gowns, lab coats, vinyl and polyethylene aprons.",
  },
  {
    handle: "foot-protection",
    label: "Foot Protection",
    description: "Shoe covers, boot covers, and foot protection for any environment.",
  },
  {
    handle: "gloves",
    label: "Gloves",
  ...
  },
  {
    handle: "tape",
    label: "Tape",
    description: "Acrylic, hot melt, filament, electrical, masking, and specialty tapes.",
  },
];

export async function getAllCategorizedProducts(): Promise<ProductCollection[]> {
